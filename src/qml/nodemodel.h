...
class NodeModel : public QObject
{
    ...
    Q_PROPERTY(QString syncTimeLeft READ syncTimeLeft NOTIFY syncTimeLeftChanged)
public:
    ...
    QString syncTimeLeft() const { return m_sync_time; }
    void setSyncTimeLeft(double new_progress);
